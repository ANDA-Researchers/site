...
const T = {
  en: {
    ...
    btn_confirm:'Confirm', btn_delete:'Delete', btn_discard:'Discard',
    confirm_title:'Confirm', loading:'Loading…',
    dirty_warn:'You have unsaved changes. Discard them?',
    drag_to_reorder:'Drag to reorder',
    no_alumni:'No alumni added yet.',
    ...
    login_backend_unavailable:'Workspace authentication is temporarily unavailable. Please try again in a moment or contact the lab administrator.',
  ...
  ko: {
    ...
    btn_confirm:'확인', btn_delete:'삭제', btn_discard:'버리기',
    confirm_title:'확인', loading:'불러오는 중…',
    dirty_warn:'저장하지 않은 변경 사항이 있습니다. 버리시겠습니까?',
    drag_to_reorder:'드래그하여 순서 변경',
    no_alumni:'아직 등록된 졸업생이 없습니다.',
    ...
    login_backend_unavailable:'워크스페이스 인증을 일시적으로 사용할 수 없습니다. 잠시 후 다시 시도하거나 연구실 관리자에게 문의하세요.',
  ...
  vi: {
    ...
    btn_confirm:'Xác nhận', btn_delete:'Xóa', btn_discard:'Bỏ thay đổi',
    confirm_title:'Xác nhận', loading:'Đang tải…',
    dirty_warn:'Có thay đổi chưa lưu. Bỏ thay đổi?',
    drag_to_reorder:'Kéo để sắp xếp lại',
    no_alumni:'Chưa có cựu thành viên nào.',
    ...
    login_backend_unavailable:'Hệ thống xác thực workspace tạm thời không khả dụng. Vui lòng thử lại sau ít phút hoặc liên hệ quản trị viên.',
