...
const T = {
  en: {
    ...
    login_backend_unavailable:'Workspace auth backend is unavailable. Update the Supabase project URL before using the admin panel.',
  ...
  ko: {
    ...
    login_backend_unavailable:'워크스페이스 인증 백엔드를 사용할 수 없습니다. 관리자 패널을 사용하려면 Supabase 프로젝트 URL을 갱신하세요.',
  ...
  vi: {
    ...
    login_backend_unavailable:'Backend xác thực của workspace hiện không khả dụng. Hãy cập nhật URL dự án Supabase trước khi dùng trang quản trị.',
