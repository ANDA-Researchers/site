  ...
  <div class="project-list">
    ...
    <article class="project-card">
      <div class="project-visual">
        <img src="{{ '/images/sub/' | append: project.image | relative_url }}" alt="{{ project.image_alt | default: project.title }}">
      </div>
      <div class="project-content">
        ...
        <div class="project-funding">
          <img src="{{ '/images/sub/' | append: project.funding_image | relative_url }}" alt="{{ project.funding_alt | default: project.funding_text | default: 'Funding logo' }}">
